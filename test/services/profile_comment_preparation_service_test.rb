...
module Ai
  class ProfileCommentPreparationServiceTest < ActiveSupport::TestCase
    class FakeCollector
    ...
    test "prepare returns ready when recent posts are analyzed with signals and identity is consistent" do
    ...
    test "prepare returns not ready when primary identity does not map to profile username" do
      account, profile = build_account_profile
