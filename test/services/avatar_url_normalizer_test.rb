...
class AvatarUrlNormalizerTest < ActiveSupport::TestCase
  test "returns nil for instagram placeholder relative path" do
  ...
  test "normalizes protocol-relative url to https" do
  ...
  test "keeps valid absolute https url" do
