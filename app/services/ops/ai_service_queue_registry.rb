  ...
  class AiServiceQueueRegistry
    ...
    SERVICE_ROWS = [
      ...
      },
      {
        ...
        job_classes: [ "ProcessPostVisualAnalysisJob", "ProcessStoryCommentVisionJob" ],
      ...
      },
      {
        ...
        job_classes: [ "ProcessPostFaceAnalysisJob", "ProcessStoryCommentFaceJob" ],
      ...
      },
      {
        ...
        job_classes: [ "ProcessPostOcrAnalysisJob", "ProcessStoryCommentOcrJob" ],
